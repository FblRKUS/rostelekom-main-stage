...
def test_index_directory(
    mock_vs_class, mock_indexer_class, mock_parse_args, mock_path_class
):
    mock_parse_args.return_value = MagicMock(path="some_dir", github=None)
...
@patch("index.CodeIndexer")
@patch("index.VectorStore")
def test_index_github(
    mock_vs_class, mock_indexer_class, mock_download, mock_parse_args
):
    mock_parse_args.return_value = MagicMock(
        path=None, github="https://github.com/owner/repo"
    )
